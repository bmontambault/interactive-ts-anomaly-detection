...
if __name__ == "__main__":
    ...
    rq_sample.to_csv('rq_sample.csv',index=False)
    rq_task1.to_csv('rq_task1.csv',index=False)
    rq_task2.to_csv('rq_task2.csv',index=False)
    
    sm_lin_sample.to_csv('sm_lin_sample.csv',index=False)
    sm_lin_task1.to_csv('sm_lin_task1.csv',index=False)
    sm_lin_task2.to_csv('sm_lin_task2.csv',index=False)
    
    tech_sample.to_csv('tech_sample.csv',index=False)
    tech_task1.to_csv('tech_task1.csv',index=False)
    tech_task2.to_csv('tech_task2.csv',index=False)
    
    health_sample.to_csv('health_sample.csv',index=False)
    health_task1.to_csv('health_task1.csv',index=False)
    health_task2.to_csv('health_task2.csv',index=False)
    
    rq_sample_anomalies.to_csv('rq_sample_anomalies.csv',index=False)
    rq_task1_anomalies.to_csv('rq_task1_anomalies.csv',index=False)
    rq_task2_anomalies.to_csv('rq_task2_anomalies.csv',index=False)
    
    sm_lin_sample_anomalies.to_csv('sm_lin_sample_anomalies.csv',index=False)
    sm_lin_task1_anomalies.to_csv('sm_lin_task1_anomalies.csv',index=False)
    sm_lin_task2_anomalies.to_csv('sm_lin_task2_anomalies.csv',index=False)
    
    tech_sample_anomalies.to_csv('tech_sample_anomalies.csv',index=False)
    tech_task1_anomalies.to_csv('tech_task1_anomalies.csv',index=False)
    tech_task2_anomalies.to_csv('tech_task2_anomalies.csv',index=False)
    
    health_sample_anomalies.to_csv('health_sample_anomalies.csv',index=False)
    health_task1_anomalies.to_csv('health_task1_anomalies.csv',index=False)
    health_task2_anomalies.to_csv('health_task2_anomalies.csv',index=False)
